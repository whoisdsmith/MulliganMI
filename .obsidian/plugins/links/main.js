...
var ObsidianProxy = class {
  constructor(app2, linkTextSuggestContext, settings) {
    this.app = app2;
...
var ObsidianLinksSettingTab = class extends import_obsidian6.PluginSettingTab {
  ...
  display() {
    ...
    const settingRemoveLinksFromHeadingsInternalLinkWithoutTextReplacemtn = new import_obsidian6.Setting(containerEl).setName("Internal wikilink without text").addDropdown((dropDown) => dropDown.addOptions({
      Delete: "Remove",
    ...
    const setLinkTestFromClipboardSetting = new import_obsidian6.Setting(containerEl).setName("Set link text from clipboard").setDesc("").addToggle((toggle) => {
    ...
    const settingCopyLink = new import_obsidian6.Setting(containerEl).setName("Copy link").setDesc("").addToggle((toggle) => {
...
var ExtractSectionCommand = class extends CommandBase {
  ...
  handler(editor, checking) {
    ...
    const currentNoteParentPath = currentView == null ? void 0 : currentView.file.parent.path;
...
// main.ts
var ObsidianLinksPlugin = class extends import_obsidian7.Plugin {
  ...
  createNotice(message, timeout) {
    return new import_obsidian7.Notice(message, timeout);
  }
  requestUrl(request) {
    return (0, import_obsidian7.requestUrl)(request);
  }
  measurePerformance(func) {
    const start2 = (0, import_obsidian7.moment)();
    try {
      func();
    } finally {
      return (0, import_obsidian7.moment)().diff(start2);
    }
  }
  async onload() {
  ...
  replaceMarkdownTargetsInNote() {
    const e = this.measurePerformance(() => {
      ...
      if (mdView && mdView.getViewData()) {
        ...
        if (count) {
          mdView.setViewData(result, false);
          new import_obsidian7.Notice(`Links: ${count} items replaced.`);
        }
      }
    });
    if (this.settings.showPerformanceNotification) {
      new import_obsidian7.Notice(`${e} ms`);
    }
  }
  ...
  onEditorPaste(evt, editor, view) {
    ...
    if (html && html.indexOf("<a") > 0) {
      const markdown = (0, import_obsidian7.htmlToMarkdown)(html);
